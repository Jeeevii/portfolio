...
export function getIcons(skillName: string) {
  ...
  switch (skillName.toLowerCase()) {
    ...
    case "express":
      return <Code className="h-8 w-8 text-zinc-300" />;
    case "python":
      return (
    ...
    case "django":
      return <Code className="h-8 w-8 text-zinc-300" />;
    case "java":
      return <Cpu className="h-8 w-8 text-zinc-300" />;
    case "spring boot":
      return <Cpu className="h-8 w-8 text-zinc-300" />;

    // Databases
    case "postgresql":
      return <Database className="h-8 w-8 text-zinc-300" />;
    case "mongodb":
      return <Database className="h-8 w-8 text-zinc-300" />;
    case "mysql":
      return <Database className="h-8 w-8 text-zinc-300" />;
    ...
    case "kubernetes":
      return <Cloud className="h-8 w-8 text-zinc-300" />;
    case "aws":
      return <Cloud className="h-8 w-8 text-zinc-300" />;
    case "ci/cd":
      return <GitBranch className="h-8 w-8 text-zinc-300" />;
    case "terraform":
      return <Cloud className="h-8 w-8 text-zinc-300" />;
    ...
    case "typescript":
      return <Code className="h-8 w-8 text-zinc-300" />;
    case "html/css":
      return <LayoutGrid className="h-8 w-8 text-zinc-300" />;
    case "next.js":
      return <Code className="h-8 w-8 text-zinc-300" />;
    case "tailwind css":
      return <LayoutGrid className="h-8 w-8 text-zinc-300" />;
    ...
    case "git":
      return <GitBranch className="h-8 w-8 text-zinc-300" />;
    case "restful apis":
      return <Globe className="h-8 w-8 text-zinc-300" />;
    case "graphql":
      return <Globe className="h-8 w-8 text-zinc-300" />;
    case "microservices":
      return <Layers className="h-8 w-8 text-zinc-300" />;
    case "agile":
      return <Code className="h-8 w-8 text-zinc-300" />;
    ...
    case "performance optimization":
      return <Settings className="h-8 w-8 text-zinc-300" />;
    case "security":
      return <Lock className="h-8 w-8 text-zinc-300" />;
    case "testing":
      return <Code className="h-8 w-8 text-zinc-300" />;
